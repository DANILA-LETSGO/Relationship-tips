...
namespace Clicker.Core
{
    ...
    /// Added inspector field `offlineEarningsMultiplier` to scale offline earnings (e.g. 0.1 = 10%).
    /// </summary>
    public class GameManager : MonoBehaviour
    {
        ...
        [Tooltip("Multiply offline earnings by this factor. 1.0 = full earnings, 0.1 = 10% of previous value.")]
        public double offlineEarningsMultiplier = 0.1;
